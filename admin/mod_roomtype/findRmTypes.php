...
$sub_array = array();
	...
	$sub_array[] = '<a  href="index.php?view=edit&id='.$result->typeID.'"" class="btn btn-warning btn-xs"><span class="glyphicon glyphicon-pencil"></span> </a> <a  href="controller.php?action=delete&id='.$result->typeID.'"" class="btn btn-danger btn-xs "><span class="glyphicon glyphicon-trash"></span> </a>';
	$data[] = $sub_array;
$i = $i + 1;		
}
