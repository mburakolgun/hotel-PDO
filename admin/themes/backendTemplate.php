...
<title>Online Reservation and Billing System: Admin</title>
...
<!-- <script type="text/javascript" src="<?php echo WEB_ROOT; ?>admin/jquery/jquery.min.js"  ></script> -->
</head>
...
$(document).ready(function() {
    var t = $('#example_data').DataTable( {
		"processing":true,
		"serverSide":true,
		"order":[],
		"ajax":{
			url:"<?php echo WEB_ROOT; ?>admin/mod_ajax/findresults.php",
			type:"POST"
		},
        "columnDefs": [ {
            "searchable": true,
...
<script type="text/javascript" charset="utf-8">
$(document).ready(function() {
    var t = $('#example_rmtypes').DataTable( {
		"processing":true,
		"serverSide":true,
		"order":[],
		"ajax":{
			url:"<?php echo WEB_ROOT; ?>admin/mod_ajax/findRmTypes.php",
			type:"POST"
		},
        "columnDefs": [ {
            "searchable": true,
...
<script type="text/javascript" charset="utf-8">
$(document).ready(function() {
    var t = $('#example_reservation').DataTable( {
		"processing":true,
		"serverSide":true,
		"order":[],
		"ajax":{
			url:"<?php echo WEB_ROOT; ?>admin/mod_ajax/findReservation.php",
			type:"POST"
		},
        "columnDefs": [ {
            "searchable": true,
...
<script type="text/javascript" charset="utf-8">
$(document).ready(function() {
    var t = $('#example_comment').DataTable( {
		"processing":true,
		"serverSide":true,
		"order":[],
		"ajax":{
			url:"<?php echo WEB_ROOT; ?>admin/mod_ajax/findComments.php",
			type:"POST"
		},
        "columnDefs": [ {
            "searchable": true,
...
<script type="text/javascript" charset="utf-8">
$(document).ready(function() {
    var t = $('#example_amenities').DataTable( {
		"processing":true,
		"serverSide":true,
		"order":[],
		"ajax":{
			url:"<?php echo WEB_ROOT; ?>admin/mod_ajax/findAmenities.php",
			type:"POST"
		},
        "columnDefs": [ {
            "searchable": true,
...
<script type="text/javascript" charset="utf-8">
$(document).ready(function() {
    var t = $('#example_user').DataTable( {
		"processing":true,
		"serverSide":true,
		"order":[],
		"ajax":{
			url:"<?php echo WEB_ROOT; ?>admin/mod_ajax/findUsers.php",
			type:"POST"
		},
        "columnDefs": [ {
            "searchable": true,
	    ...
	    <div class="navbar navbar-fixed-top navbar-inverse" role="navigation">
	      <div class="container">
	        <div class="navbar-header">
	          ...
	          <a class="navbar-brand" href="<?php echo WEB_ROOT; ?>admin/index.php">Online Reservation and Billing System</a>
	        </div>
...
<?php 
 require_once $content;?>
	...
	<hr>
	     <footer>
        <p>&copy; Online Reservation and Billing System </p>
        <script>
 
          $(document).on("click",".roomdel",function(e){ 
          ...
          $(document).on("click",".roomtypesdel",function(e){ 
           ...
           $(document).on("click",".amendel",function(e){ 
