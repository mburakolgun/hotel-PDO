...
$sub_array = array();
	...
	$sub_array[] = '<a  href="index.php?view=edit&id='.$result->roomNo.'"" class="btn btn-warning btn-xs"><span class="glyphicon glyphicon-pencil"></span> </a> <a  href="controller.php?action=delete&id='.$result->roomNo.'"" class="btn btn-danger btn-xs roomdel"  data-id="'.$result->roomNo.'"><span class="glyphicon glyphicon-trash"></span> </a>';
	$data[] = $sub_array;
$i = $i + 1;		
}
