...
$_SESSION['adult'] = isset($_POST['ADULT']) ? $_POST['ADULT'] : 0;
$_SESSION['children'] =  isset($_POST['CHILDREN']) ? $_POST['CHILDREN'] :0;
...
<title>Online Reservation and Billing System: <?php echo $title; ?></title>
...
<link href="<?php echo WEB_ROOT; ?>css/bootstrap-datetimepicker.min.css" rel="stylesheet" media="screen">
   <script type="text/javascript" language="javascript" src="<?php echo WEB_ROOT; ?>js/jquery.js"></script>
    ...
    <script type="text/javascript" src="<?php echo WEB_ROOT; ?>datepicker/datepicker.js"></script>
  <link href="<?php echo WEB_ROOT; ?>datepicker/datepicker.css" rel="stylesheet" type="text/css" />
	    ...
	    <div class="navbar navbar-fixed-top navbar-inverse" role="navigation">
	      <div class="container">
	        <div class="navbar-header">
	          ...
	          <a class="navbar-brand" href="<?php echo WEB_ROOT; ?>index.php">Online Reservation and Billing System</a>
	        </div>
	     ...
	     <!--        <li><a href="<?php echo WEB_ROOT; ?>index.php?page=7">Site Map</a></li> -->
	     	   <li><a href="<?php echo WEB_ROOT; ?>booking/"><span class="glyphicon glyphicon-shopping-cart"></span></a></li>  
